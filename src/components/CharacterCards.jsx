...
function CharacterCards() {
  ...
  const characters = [
    ...
    { name: 'Infinite', image: 'https://via.placeholder.com/150', description: 'A mysterious warrior with unmatched power and a dark past.', game: 'Sonic Forces', path: './CardsModel/infinite.glb', funFact: 'Infinite\'s power stems from the Phantom Ruby, making him a formidable opponent with limitless abilities!' },
    { name: 'Jet the Hawk', image: 'https://via.placeholder.com/150', description: 'The leader of the Babylon Rogues, known for his speed and aerial tricks.', game: 'Sonic Riders', path: './CardsModel/jetHawk.glb', funFact: 'Jet is a master of hovercraft racing, blending speed with style in every competition!' },
